<template>
<div>
<h1 style="margin-top: 0em;">Requesting access to PhysioNet Clinical Databases</h1>
<article style="margin: 0.5em 1em;">


</article>
<article id="page">
<p>N.B.: if you have been granted access to the MIMIC-III Clinical Database, you also have access to the MIMIC-II Clinical Database. There is no need to request access separately.</p> 

<p> The contents of restricted-access clinical databases maintained by
PhysioNet were derived from original data that contained protected
health information (PHI), as defined by
<a href="http://www.hhs.gov/ocr/hipaa/" target="other">HIPAA</a>.  The
providers of the data have given scrupulous attention to the task of locating
and removing all PHI, so that the remaining data can be
considered <a href="http://privacyruleandresearch.nih.gov/pr_08.asp#8a" target="other">de-identified</a> and therefore not subject to the HIPAA Privacy
Rule restrictions on sharing PHI.  Nevertheless, because of the richness and
detail of the MIMIC databases, they will be released only to legitimate researchers
under the terms and conditions described on this page.

</p><p><em>If you agree to all of these terms and conditions, access to
restricted information within PhysioNet clinical databases may be
granted to you <strong>as an individual</strong>. Your colleagues may
obtain access to these data as individuals via the same procedure you
are following.</em>
...
<ul>
<li>
Complete the CITI (Collaborative Institutional Training Initiative at the University of Miami) “Data or Specimens Only Research” course as an MIT affiliate, as described in the <a href="CITI_instructions.shtml">instructions for completing required CITI training</a>.</li>

<li> Read the terms of the agreement (below) carefully and click on “I agree” if you
agree and wish to continue, or on “I do not agree” otherwise. 
If you click on “I agree”, your browser will display a data use agreement form for you to complete and submit.
If you click on “I do not agree”, your browser returns to the PhysioNet home page.</li>
</ul>

<h2>PhysioNet Clinical Database Restricted Data Use Agreement</h2>

<p>If I am granted access to PhysioNet Clinical Databases (<a href="/works/MIMICIIClinicalDatabase/">MIMIC-II</a>, <a href="/works/MIMICIIIClinicalDatabase/">MIMIC-III</a>, <a href="/works/eICUCollaborativeResearchDatabase/">eICU Collaborative Research Database</a>, <a href="/works/DeidentifiedMedicalText">Deidentified Medical Text</a>, <a href="/works/MIMICCXR">MIMIC-CXR</a>), I agree to the terms and conditions below:</p>

<div style="border: 2px solid #440; background-color: #fffffc; margin: 1em 0; padding: 1em 2em; font-size: 1.1em;">
<ol>
<li>I will not attempt to identify any individual or institution referenced in PhysioNet restricted data.</li>
<li>I will exercise all reasonable and prudent care to avoid disclosure of the identity of any individual or institution referenced in PhysioNet restricted data in any publication or other communication.</li>
<li>I will not share access to PhysioNet restricted data with anyone else.</li>
<li>I will exercise all reasonable and prudent care to maintain the physical and electronic security of PhysioNet restricted data.</li>
<li>If I find information within PhysioNet restricted data that I believe might permit identification of any individual or institution, I will report the location of this information promptly by email to <a href="mailto:PHI-report@physionet.org">PHI-report@physionet.org</a>, citing the location of the specific information in question so that it can be investigated and removed if necessary.</li>
<li>I have requested access to PhysioNet restricted data for the sole purpose of lawful use in scientific research, and I will use my privilege of access, if it is granted, for this purpose and no other.</li>
<li>I have completed a training program in human research subject protections and HIPAA regulations, and I am submitting proof of having done so.</li>
<li>I will indicate the general purpose for which I intend to use the database in my application.</li>
<li>If I openly disseminate my results, I will also contribute the code used to produce those results to a repository that is open to the research community.</li>
<li>This agreement may be terminated by either party at any time, but my obligations with respect to restricted data from PhysioNet shall continue after termination.</li>
</ol>
 

</div>

<form method="post" action="/pnw/a/manage-duas" enctype="multipart/form-data" style="text-align: center; padding-bottom: 3em;">
<input type="hidden" name="document_uri" value="/works/MIMICIIIClinicalDatabase/access.shtml">
	<button class="agreebtn" @click="agree()" >I agree</button>
	<button class="notagreebtn" @click="notagree()">I don't agree</button></form>
...
a[href='#top'] { border-style: solid; border-width: thin; border-color: #694;
		  ...
		  text-decoration: none; padding: 1px; padding: .2em .4em; font-size: .9em; margin-bottom: 2em; display: inline-block;} /* changed by KP 10/2015; additional change (bottom margin, display) 6/2016; changed by KP 19Jan2019: changed href^= to href=  */
