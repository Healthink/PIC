...
-- subject_id
ALTER TABLE INPUTEVENTS DROP FOREIGN KEY inputevents_fk_subject_id;
...
-- hadm_id
ALTER TABLE INPUTEVENTS DROP FOREIGN KEY inputevents_fk_hadm_id;
ALTER TABLE INPUTEVENTS
...
-- icustay_id
ALTER TABLE INPUTEVENTS DROP FOREIGN KEY inputevents_fk_icustay_id;
ALTER TABLE INPUTEVENTS
ADD CONSTRAINT inputevents_fk_icustay_id
  FOREIGN KEY (ICUSTAY_ID)
  REFERENCES ICUSTAYS(ICUSTAY_ID);
